...
This tool is intended to be used in combination with 3D Tiles support in MapBox GL JS (using https://github.com/Geodan/mapbox-3dtiles). Loading

the tileset in Cesium is not supported.
