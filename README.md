...
2026-03-24: release 2.18.1: Improve error handling when using GPU Instancing and Draco compressed input models and improve user feedback for table bounding box
