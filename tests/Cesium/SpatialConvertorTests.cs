...
namespace i3dm.export.tests.Cesium
{
    public class SpatialConvertorTests
    {
        ...
        public void TestMercatorProjection()
        {
            var lon = 5.139838;
            var lat = 52.086577;
            var res = SpatialConvertor.ToSphericalMercatorFromWgs84(lon, lat);

            Assert.IsTrue(res[0] == 572164.14884027175);
            Assert.IsTrue(res[1] == 6815794.8490610179);

            var res1 = SpatialConvertor.ToWgs84FromSphericalMercator(res[0], res[1]);
        ...
        public void EastNorthUpTesting()
        {
            ...
            var center = SpatialConvertor.GeodeticToEcef(lon, lat, 0);
