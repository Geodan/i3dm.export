...
class Program
{
    static void Main(string[] args)
    {
        ...
        parser.ParseArguments<Options>(args).WithParsed(o =>
        {
            ...
            var tilesetjson = TreeSerializer.ToImplicitTileset(rootBoundingVolumeRegion, o.GeometricError, availableLevels, subtreeLevels, version, (bool)o.UseGpuInstancing, (bool)o.UseI3dm, tilesetVersion, keepProjection, proj);
